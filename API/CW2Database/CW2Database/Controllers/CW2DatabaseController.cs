...
using CW2Database; // Add this using directive
using System.Net.Http;
using Newtonsoft.Json;

namespace CW2Database.Controllers
{
    [ApiController]
    [Route("api/[controller]")]
    public class CW2DatabaseController : ControllerBase
    {
        private readonly AuthenticatorService _authenticatorService;
        private readonly ILogger<CW2DatabaseController> _logger;
        private readonly HttpClient _httpClient;
        private readonly CW2Database _dbContext;

        public CW2DatabaseController(AuthenticatorService authenticatorService, ILogger<CW2DatabaseController> logger, IHttpClientFactory httpClientFactory,
                                     CW2Database dbContext)
        {
        ...
        {
            return _dbContext.UserData.Any(e => e.Email == email);
        }
