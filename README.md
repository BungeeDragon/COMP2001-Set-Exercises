...
Version control for CW1 and content for CW2 that contains
- Database SQL Query created with schema CW1 (Within Semester1_Queries folder)
- Database SQL Query created with schema CW2 (Within Semester2_Queries folder)
